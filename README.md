...
| anonymization    | `string`                 | The anonymization method used for this field. If the field contains PII, this field should be set to the anonymization method used. Examples: hashed, masked, none.                                                                                                                                                                                                                                                                                                                   |
