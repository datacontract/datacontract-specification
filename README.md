...
The [Data Contract CLI](https://cli.datacontract.com) is a command line tool and Python library to lint, test, import
and export data contracts.
...
| filter      | [Filter Object](#filter-object)              | Filter expression to be applied to the data set.                                                                                     |
...
| Field      | Type     | Description                                          |
|------------|----------|------------------------------------------------------|
| expression | `string` | The filter expression to be applied to the data set. |
